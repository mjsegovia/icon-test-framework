  ...
  Scenario Outline: Successfully retrieve a list of users for a specific page
   ...
   When I send a GET request to with the query parameter 'page' set to '12'
   Then the response status code should be 200    
    And the page number returned matches with the one spec ified in the URL
    And the response should not contain usersendPoint